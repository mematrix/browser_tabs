...
class SettingsProvider extends ChangeNotifier {
  ...
  Future<void> _loadSettings() async {
    ...
    _enablePerformanceMonitoring = prefs.getBool('enablePerformanceMonitoring') ?? true;
  ...
  Future<void> _saveSettings() async {
    ...
    // Performance settings
    await prefs.setBool('enablePerformanceMonitoring', _enablePerformanceMonitoring);
    ...
    await prefs.setInt('maxConcurrentAiTasks', _resourceConfig.maxConcurrentAiTasks);
    await prefs.setInt('maxDatabaseSizeMb', _resourceConfig.maxDatabaseSizeMb);
    await prefs.setBool('adaptiveManagement', _resourceConfig.adaptiveManagement);
    await prefs.setInt('backgroundIntervalSecs', _resourceConfig.backgroundIntervalSecs);
